            ...
            <div className="grid gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:items-start">
              ...
              <div className="lg:pt-8">
                <p className="max-w-md text-lg leading-8 text-muted">
                  Aquí se agrupan las piezas que entran en compra directa. El
                  encargo personalizado sigue yendo por contacto para mantener
                  control de acabado, presencia y criterio.
                </p>
                ...
                <div className="mt-10 space-y-8">
                  ...
                  {hasItems ? (
                    <button
                      type="button"
                      onClick={clearCart}
                      className="inline-flex text-sm font-semibold uppercase tracking-[0.08em] text-muted transition duration-200 hover:text-foreground"
                    >
                      Vaciar carrito
                    </button>
                  ) : null}
                      ...
                      <div className="flex flex-wrap items-center justify-between gap-4">
                        ...
                        <div className="flex items-center gap-4">
                          ...
                          <button
                            ...
                            className="text-sm font-semibold uppercase tracking-[0.08em] text-muted transition duration-200 hover:text-foreground"
                          >
                            Quitar
                          </button>
                        </div>
            ...
            <FadeIn amount={0.12} delay={0.04}>
              <aside className="h-fit rounded-[2.4rem] border border-border bg-card p-6 shadow-sm md:p-8">
                ...
                <p className="mt-6 text-sm leading-7 text-muted">
                  El checkout real y la integración de pago aún no están
                  conectados. Esta base ya prepara la lógica para ese siguiente
                  paso.
                </p>
              ...
              <div className="grid gap-8 border-t border-border pt-10 lg:grid-cols-[0.78fr_1.22fr]">
                ...
                <div>
                  ...
                  <p className="mt-6 max-w-xl text-base leading-8 text-muted">
                    Puedes volver a la selección y empezar por las piezas que ya
                    permiten compra directa.
                  </p>

                  <Link
                    href="/productos"
                    className="mt-8 inline-flex rounded-full border border-foreground bg-foreground px-6 py-3 text-sm font-semibold uppercase tracking-[0.08em] text-background transition duration-300 hover:-translate-y-0.5 hover:border-olive hover:bg-olive"
                  >
                    Ver piezas
                  </Link>
                </div>
